...
const LazyImage = ({ portfolioImg, img }) => {
  ...
  const {alt, mobile1x, tablet1x, desktop1x} = img;
  ...
  return (
      <picture>
          <source
            ...
            data-srcset={`${img.desktop1x} 1x, ${img.desktop2x} 2x`} 
          />
          <source
            media="(min-width: 768px)" 
            data-srcset={`${img.tablet1x} 1x, ${img.tablet2x} 2x`}
          />
          <source
            media="(max-width: 767px)" 
            data-srcset={`${img.mobile1x} 1x, ${img.mobile2x} 2x`} 
          />
